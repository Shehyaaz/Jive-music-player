...
class MainWindow(QMainWindow, Ui_MainWindow):
    def __init__(self, *args, **kwargs):
        ...
        QTimer.singleShot(2000,self.setUpMainWindow)
...
if __name__ == '__main__':
    ...
    palette = QPalette()
    palette.setColor(QPalette.Window, QColor(135, 135, 135))
    palette.setColor(QPalette.WindowText, Qt.white)
    palette.setColor(QPalette.Base, QColor(100, 100, 100))
    palette.setColor(QPalette.AlternateBase, QColor(135, 135, 135))
    palette.setColor(QPalette.ToolTipBase, Qt.white)
    palette.setColor(QPalette.ToolTipText, Qt.white)
    palette.setColor(QPalette.Text, Qt.white)
    palette.setColor(QPalette.Button, QColor(135, 135, 135))
